...
Этот репозиторий содержит готовый код парсера, который мы разбираем в лекциях. На основе него будет задаваться домашнее задание. Инструкция по выполнению лежит **[ТУТ](.github/CONTRIBUTING.md)** :godmode:
